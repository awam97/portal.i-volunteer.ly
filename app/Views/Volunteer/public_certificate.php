...
<?php foreach ($entities as $entity) :;?>
    <div class="certificate">           
        ...
        <div class="logos">
            <?php echo $barcode ;?>
            <img width="90px" src="https://portal.i-volunteer.ly/uploads/logo-color-1.png"></img>
        </div>                  
        <center><h1><b><?php echo $db->table('volunteers')->where('id',$entity->volunteer_id)->get()->getRow()->name;?><b></h1></center>
        <hr>
        <div class="content">
            <center><h2><b>            
    تشهد إدارة منصة أنا متطوع بأن المتطوع/ـة المذكور أسمه/هـا أعلاه قد شارك/ت في <b><?php echo $db->table('activities')->where('id',$entity->activity_id)->get()->getRow()->name;?><b>
    ...
    <br><br>بارك الله جهودكم و جزاكم عنا خير الجزاء
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td style="width:22%;vertical-align:top !important">
                    </td>
                    <td style="width:22%;vertical-align:top !important">                        
                    ...
                    <td style="width:33%;vertical-align:top !important">
                        ...
                        <img width="240px" src="https://portal.i-volunteer.ly/uploads/signature.png"></img>
                    </td> 
                </tr>                                                    
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td style="vertical-align:bottom !important">
                        <img style="width:70px;margin-right:70px" src="https://portal.i-volunteer.ly/uploads/4.png"></img>
                    </td>
                    <td style="font-size:18px!important;vertical-align:bottom !important">                        
                        المنصة بإشراف منظمة شباب العمل التطوعي
                    </td>  
                </tr>                                                    
            </tbody>
        </table>
