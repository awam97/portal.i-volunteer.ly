...
oPaginate:{sFirst:"First",sLast:"الاخيرة",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"لا توجد بيانات.",sInfo:"عرض من سجل  [ _START_ ] إلى  سجل [ _END_  ] من اصل [ _TOTAL_ ] سجل",sInfoEmpty:"عرض 0 الى 0 من 0 بيانات.",sInfoFiltered:"",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض  _MENU_",sLoadingRecords:"جاري التحميل...",sProcessing:"جاري المعالجة...",sSearch:"بحث: ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لا توجد بيانات."},oSearch:h.extend({},
...
" ui-corner-bl ui-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["السابق","التالي"]},full:function(){return["first","السابق","التالي","الاخيرة"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["السابق",Aa(a,b),"التالي"]},full_numbers:function(a,b){return["first","السابق",Aa(a,b),"التالي","الاخيرة"]},_numbers:Aa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||
{},k,l,m=0,p=function(b,d){var n,r,t,s,v=function(b){Ta(a,b.data.action,true)};n=0;for(r=d.length;n<r;n++){s=d[n];if(h.isArray(s)){t=h("<"+(s.DT_el||"div")+"/>").appendTo(b);p(t,s)}else{k=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "first":k=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "السابق":k=j.sPrevious;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "التالي":k=j.sNext;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "الاخيرة":k=
